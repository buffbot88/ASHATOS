...
/// <summary>
/// Game Engine Module - Provides a robust game engine integration controllable by RaCore AI modules.
/// Supports scene management, entity creation, AI-driven world generation, and real-time updates.
/// </summary>
[RaModule(Category = "extensions")]
public sealed class GameEngineModule : ModuleBase, IGameEngineModule
{
    public override string Name => "GameEngine";
