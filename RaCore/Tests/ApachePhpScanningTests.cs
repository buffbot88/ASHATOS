...
namespace RaCore.Tests
{
    ...
    /// Verifies that RaOS correctly scans for Apache httpd.conf and PHP php.ini
    /// from the static configuration folder at C:\RaOS\webserver\settings
    /// </summary>
    public class ApachePhpScanningTests
    {
        ...
        private static void TestApacheScanningMethod()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("     This is expected if C:\\RaOS\\webserver\\settings\\httpd.conf doesn't exist");
                }
            }
            catch (Exception ex)
            {
        ...
        private static void TestPhpScanningMethod()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("     This is expected if C:\\RaOS\\webserver\\settings\\php.ini doesn't exist");
                }
            }
            catch (Exception ex)
            {
        ...
        private static void TestConfigVerificationMethods()
        {
            ...
            try
            {
                ...
                var tempDir = Path.Combine(Path.GetTempPath(), "raos_test");
