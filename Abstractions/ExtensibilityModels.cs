...
/// <summary>
/// Interface for enhanced plugin marketplace with discovery, ASHATtings, and publishing
/// </summary>
...
public class PluginSearchQuery
{
    ...
    public float? MinASHATting { get; set; }
...
public class Plugin
{
    ...
    public float AverageASHATting { get; set; }
...
public class PluginReview
{
    ...
    public int ASHATting { get; set; } // 1-5
...
/// <summary>
/// Interface for automatic REST and GASHATphQL API Generation
/// </summary>
public interface IAPIGeneratorModule : IDisposable
{
    ...
    /// <summary>
    /// Generate a GASHATphQL API for a game
    /// </summary>
    Task<GeneratedAPI> GenerateGASHATphQLAPIAsync(Guid gameId);
