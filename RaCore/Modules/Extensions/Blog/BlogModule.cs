...
namespace RaCore.Modules.Extensions.Blog;
  ...
  help - Show this help message";
    ...
    private void SeedExampleData()
    {
        ...
        var post1 = new BlogPost
        {
            ...
            UserId = "user1",
            Username = "RaAI",
            Title = "Welcome to RaCore Blogs",
            Content = "This is the first blog post on RaCore. Share your thoughts, stories, and ideas with the community!",
        ...
        var post2 = new BlogPost
        {
            ...
            UserId = "user2",
            Username = "TechUser",
            Title = "Getting Started with RaCore",
            Content = "A comprehensive guide to using RaCore's blogging features.",
            Category = "Tutorials",
