...
/// <summary>
/// Compliance and regulatory reporting module for RaCore.
...
public sealed class ComplianceModule : ModuleBase, IComplianceModule
{
    ...
    public async Task<AgeVerification> VerifyUserAgeAsync(string userId, DateTime? dateOfBirth, AgeVerificationMethod method)
    {
        await Task.CompletedTask;
