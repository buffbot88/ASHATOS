...
namespace RaCore.Modules.Extensions.FeatureExplorer;
...
public sealed class FeatureExplorerModule : ModuleBase, IDisposable
{
    ...
    private static List<string> DetectOtherComponents()
    {
        ...
        TryDetect("RaCore.Modules.DigitalFace.DigitalFaceControl", list, "DigitalFaceControl (UI)");
        TryDetect("RaCore.Modules.DigitalFace.Rendering.GdiParticleRenderer", list, "GdiParticleRenderer");
        TryDetect("RaCore.Modules.DigitalFace.Rendering.FaceInputs", list, "FaceInputs");
        return list;
    }
