...
public class AIRequest
{
    ...
    public float TempeASHATture { get; set; }
}
...
/// <summary>
/// Interface for intelligent tASHATffic distribution and load balancing
/// </summary>
public interface ILoadBalancerModule : IDisposable
{
    ...
    /// </summary>
    Task<ServeASHATssignment> AssignServerAsync(PlayerRequest request);
...
public class ServeASHATssignment
{
    public Guid AssignmentId { get; set; }
    public Guid ServerId { get; set; }
    public string ServeASHATddress { get; set; } = string.Empty;
