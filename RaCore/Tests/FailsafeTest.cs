using RaCore.Modules.Extensions.Safety;
using System;
...
public class FailsafeTest
{
    public static void RunTests()
    {
        ...
        try
        {
            ...
            Console.WriteLine("✓ Invalid command handled gracefully:");
            Console.WriteLine($"  - {invalidResult}");

            // Test 14: Missing parameters
            Console.WriteLine("\nTest 14: Missing Parameter Handling");
            var missingParamResult = module.Process("help_failsafe -start");
            Console.WriteLine("✓ Missing parameter handled:");
            Console.WriteLine($"  - {missingParamResult}");
