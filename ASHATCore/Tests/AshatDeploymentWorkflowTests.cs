...
public class AshatDeploymentWorkflowTests
{
    ...
    private static void TestConfigurePublicServer()
    {
        ...
        var module = CreateModule();
        var result = module.Process("configure public http://agpstudios.online PublicStaging");
        ...
        if (!result.Contains("http://agpstudios.online"))
    ...
    private static void TestConfigureOmegaServer()
    {
        ...
        var module = CreateModule();
        var result = module.Process("configure omega https://us-omega.raos.io Omega(Live)");
        
        if (!result.Contains("✅ Server configured successfully"))
            throw new Exception("Server Configuration failed");
        if (!result.Contains("OMEGA"))
            throw new Exception("Server type not displayed");
        if (!result.Contains("https://us-omega.raos.io"))
            throw new Exception("Server URL not displayed");
    ...
    private static void TestPushToPublicServer()
    {
        ...
        var module = CreateModule();
        module.Process("configure public https://us-omega.raos.io PublicStaging");
    ...
    private static void TestVerifyDeployment()
    {
        ...
        var module = CreateModule();
        module.Process("configure public http://agpstudios.online PublicStaging");
    ...
    private static void TestApproveForOmega()
    {
        ...
        var module = CreateModule();
        module.Process("configure public http://agpstudios.online PublicStaging");
        module.Process("configure omega https://us-omega.raos.io OmegaLive");
    ...
    private static void TestCompleteWorkflow()
    {
        ...
        var configPublic = module.Process("configure public http://agpstudios.online PublicStaging");
