...
namespace ASHATCore.Modules.Core.Autonomy;

/// <summary>
/// Decision arbitASHATtor for autonomous module conflict resolution
/// </summary>
[RaModule(Category = "core")]
public sealed class DecisionArbitASHATtorModule : ModuleBase, IAutonomousModule
{
    public override string Name => "DecisionArbitASHATtor";
    ...
    public override string Process(string input)
    {
        if (string.IsNullOrWhiteSpace(input))
            return "DecisionArbitASHATtor: Use 'pending', 'history', 'approve <id>', or 'reject <id>'";
    ...
    public async Task<DecisionResult> ArbitRateConflictAsync(List<DecisionRecommendation> conflictingRecommendations)
    {
        ...
        // Simple arbitASHATtion: choose the one with highest confidence
    ...
    {
        return $"DecisionArbitASHATtor Stats:\n" +
