...
namespace RaCore.Modules.Extensions.CodeGeneration;
...
public sealed class AICodeGenModule : ModuleBase
{
    ...
    private string GenerateReadme(ProjectTemplate template, List<string> features, string originalPrompt)
    {
        ...
        sb.AppendLine();
        sb.AppendLine($"This project was generated by RaCore AI Code Generation based on the prompt:");
        ...
        sb.AppendLine("---");
        sb.AppendLine();
        sb.AppendLine($"**Generated by**: RaCore AI Code Generation Module");
  ...
  <ItemGroup>
    ...
    private string GenerateCSharpProgram(ProjectTemplate template, List<string> features)
    {
        ...
        sb.AppendLine("            Console.WriteLine(\"Generated by RaCore AI Code Generation\");");
    ...
    private string GeneratePythonMain(ProjectTemplate template, List<string> features)
    {
        ...
        sb.AppendLine("    print(\"Generated by RaCore AI Code Generation\")");
        sb.AppendLine("    print()");
        sb.AppendLine();
        sb.AppendLine("    # Load game configuration");
...
";
    ...
    private string GenerateGameConfig(ProjectTemplate template, List<string> features)
    {
        var gameConfig = new
        {
            ...
            version = "1.0.0",
            generated_by = "RaCore AI Code Generation",
