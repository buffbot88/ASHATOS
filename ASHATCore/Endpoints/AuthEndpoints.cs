...
public static class AuthEndpoints
{
    ...
    public static WebApplication MapAuthEndpoints(this WebApplication app, IAuthenticationModule? authModule)
    {
        if (authModule == null)
        {
            Console.WriteLine("[ASHATCore] Authentication module not available - skipping auth endpoints");
            return app;
        }
        ...
        Console.WriteLine("[ASHATCore] Authentication API endpoints registered:");
