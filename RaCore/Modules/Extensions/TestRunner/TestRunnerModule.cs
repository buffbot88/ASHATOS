...
namespace RaCore.Modules.Extensions.TestRunner;
...
public sealed class TestRunnerModule : ModuleBase, IDisposable
{
    ...
    private string RunSuite(bool fast, bool asJson, int? seed, bool verifyOrder)
    {
        ...
        var hasDfx = ModulePresent("DigitalFace") || ModulePresent("DigitalFaceControl") || HasType("RaCore.Modules.DigitalFace.DigitalFaceControl");
