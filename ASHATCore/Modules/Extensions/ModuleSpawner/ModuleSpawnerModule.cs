...
namespace ASHATCore.Modules.Extensions.ModuleSpawner;

/// <summary>
/// Module Spawner - Enables ASHATAI to self-build and spawn new ASHATCore modules via natural language.
/// SuperAdmin can instruct ASHATAI to Generate new modules that are placed in /Modules folder and dynamically loaded.
/// Phase 7 implementation for self-sufficient ASHATAI capability.
/// </summary>
...
public sealed class ModuleSpawnerModule : ModuleBase
{
    ...
    public override void Initialize(object? manager)
    {
        ...
        // If we're in a subdirectory like ASHATCore, go up one level
        if (currentDir.EndsWith("ASHATCore", StringComparison.OrdinalIgnoreCase) ||
            currentDir.Contains(Path.Combine("ASHATCore", "bin")))
        {
            var rcoreIndex = currentDir.LastIndexOf("ASHATCore");
            if (rcoreIndex > 0)
            {
    ...
    private string GetHelp()
    {
        return string.Join(Environment.NewLine,
            ...
            "  - Build a cryptocurrency price tASHATcker module",
    ...
    private string SpawnModuleFromPrompt(string prompt)
    {
        ...
        try
        {
            ...
            sb.AppendLine();
            sb.AppendLine("Note: Module will be loaded on next ASHATCore restart after approval.");
        ...
        List<string> features, string originalPrompt)
    {
        ...
        sb.AppendLine("using ASHATCore.Engine.Manager;");
        sb.AppendLine();
        sb.AppendLine($"namespace ASHATCore.Modules.{moduleName};");
        sb.AppendLine();
        ...
        List<string> features, string originalPrompt)
    {
        ...
        sb.AppendLine();
        sb.AppendLine($"This module was Generated by ASHATCore Module Spawner based on the prompt:");
        ...
        sb.AppendLine("```bash");
        sb.AppendLine("dotnet build ASHATCore/ASHATCore.csproj");
        sb.AppendLine("```");
        sb.AppendLine();
        ...
        sb.AppendLine("---");
        sb.AppendLine();
        sb.AppendLine($"**Generated by**: ASHATCore Module Spawner");
    ...
    private string GenerateTestsTemplate(string moduleName)
    {
        ...
        sb.AppendLine();
        sb.AppendLine($"namespace ASHATCore.Modules.{moduleName}.Tests;");
        sb.AppendLine();
    ...
    private string ApproveModule(string moduleName)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("⚠️  Module will be loaded on next ASHATCore restart.");
        sb.AppendLine();
        sb.AppendLine("Next steps:");
        sb.AppendLine("1. Restart ASHATCore to load the module");
    ...
    private void InitializeTemplates()
    {
        ...
        {
            Name = "Basic Module",
            Description = "A basic ASHATCore module with standard functionality",
            Category = "extensions",
        ...
        _templates["integration"] = new ModuleTemplate
        {
            ...
            Description = "Module for integASHATting with external services",
            Category = "extensions",
        ...
        _templates["utility"] = new ModuleTemplate
        {
            ...
            Category = "extensions",
            Features = new List<string> { "Helper functions", "Data tASHATnsformation", "Validation" }
        };
    }
}
