...
public class DigitalFaceControl
{
    internal void UpdateNeuralState(NeuralState neuralState)
    {
    ...
    internal class Mood
    {
        public static Mood Happy { get; internal set; }
        public static Mood Confused { get; internal set; }
        public static Mood Thinking { get; internal set; }
        public static Mood Speaking { get; internal set; }
        public static Mood Neutral { get; internal set; }
    }
}
