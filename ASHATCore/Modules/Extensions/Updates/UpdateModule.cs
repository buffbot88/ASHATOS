...
namespace ASHATCore.Modules.Extensions.Updates;
...
public sealed class UpdateModule : ModuleBase, IUpdateModule
{
    ...
    private static string CurrentVersion => ASHATVersion.Current; // Unified version from ASHATVersion class
    ...
    public async Task<UpdatePackage> CreateUpdatePackageAsync(string version, string changelog, byte[] packageData)
    {
        ...
        // Save package file
        var packageFileName = $"ASHATCore_Update_{version}_{package.Id}.zip";
