...
/// <summary>
/// Failsafe Backup Module - Provides emergency backup and restoration capabilities for RaOS.
...
public sealed class FailsafeModule : ModuleBase
{
    ...
    private string GetFailsafeHelp()
    {
        return string.Join(Environment.NewLine,
            ...
            "",
            "The Failsafe system protects RaOS from corruption by:",
