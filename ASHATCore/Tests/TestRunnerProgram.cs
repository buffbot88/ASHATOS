...
public class TestRunner
{
    public static async Task Main(string[] args)
    {
        ...
        // Run Compliance tests if requested (Issue #255)
        if (args.Length > 0 && args[0].ToLowerInvariant() == "windowofASHAT")
        {
            Console.WriteLine("\n\n╔════════════════════════════════════════════════════════╗");
            Console.WriteLine("║   Compliance Test Suite (Issue #255)     ║");
            Console.WriteLine("╚════════════════════════════════════════════════════════╝\n");
            
            WindowOfASHATComplianceTests.RunTests();
        }
