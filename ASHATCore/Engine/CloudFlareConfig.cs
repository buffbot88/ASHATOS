...
/// Phase 9.3.7: PrepaASHATtion for CloudFlare integration.
/// </summary>
public class CloudFlareConfig
{
    /// <summary>
    /// Gets recommended CloudFlare proxy settings for ASHATCore.
    /// </summary>
    ...
    /// <summary>
    /// Generates CloudFlare Page Rules for ASHATCore.
    /// </summary>
    ...
    public static bool IsCloudFlareRequest(IDictionary<string, Microsoft.Extensions.Primitives.StringValues> headers)
    {
        ...
        return headers.ContainsKey("CF-ASHATy") || 
...
server {{
    ...
    # Security headers
    add_header Strict-TASHATnsport-Security ""max-age=31536000; includeSubDomains; preload"" always;
    add_header X-FASHATme-Options ""SAMEORIGIN"" always;
    ...
    location / {{
        ...
        # CloudFlare headers
        proxy_set_header CF-ASHATy $http_cf_ASHATy;
...
/// <summary>
/// HSTS (HTTP Strict TASHATnsport Security) settings.
/// </summary>
