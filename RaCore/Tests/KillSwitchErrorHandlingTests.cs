...
namespace RaCore.Tests
{
    ...
    public class KillSwitchErrorHandlingTests
    {
        ...
        private static void TestKillSwitchEnvironmentVariables()
        {
            ...
            // Test RACORE_SKIP_NGINX_CHECK
            Console.WriteLine("  Scenario 1: RACORE_SKIP_NGINX_CHECK not set");
            var nginxCheck = Environment.GetEnvironmentVariable("RACORE_SKIP_NGINX_CHECK");
            ...
            // Test RACORE_SKIP_PHP_CHECK
            Console.WriteLine("  Scenario 2: RACORE_SKIP_PHP_CHECK not set");
            var phpCheck = Environment.GetEnvironmentVariable("RACORE_SKIP_PHP_CHECK");
            ...
            Environment.SetEnvironmentVariable("RACORE_SKIP_NGINX_CHECK", "true");
            nginxCheck = Environment.GetEnvironmentVariable("RACORE_SKIP_NGINX_CHECK");
            ...
            // Clean up
            Environment.SetEnvironmentVariable("RACORE_SKIP_NGINX_CHECK", null);
        }
        ...
        private static void TestPermissionDeniedDetection()
        {
            ...
            var testPath = Path.Combine(Path.GetTempPath(), "racore-nonexistent", "test.ini");
