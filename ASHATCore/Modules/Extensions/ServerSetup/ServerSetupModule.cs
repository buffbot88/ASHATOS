...
/// <summary>
/// Server Setup Module - Manages Database folders, FTP, and per-admin instance Configurations.
...
public sealed class ServerSetupModule : ModuleBase, IServerSetupModule
{
  ...
  serversetup ftp createuser username=<name> path=<path> - Create restricted FTP user",
    ...
    private string GenerateAdminReadme(string licenseNumber, string username)
    {
        ...
        sb.AppendLine("├── wwwroot/            # Web root for web server");
        ...
        sb.AppendLine("4. ASHATCore AI can automatically configure web server");
        sb.AppendLine();
