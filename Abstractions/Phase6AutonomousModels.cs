...
public class NPCPersonality
{
    ...
    public float Extraversion { get; set; } // 0-1: Outgoing vs Reserved
...
public class StoryChapter
{
    ...
    public List<StoryBranch> Branches { get; set; } = new();
...
/// <summary>
/// Interface for real-time collaborative world editing
/// </summary>
...
public class EditingPermissions
{
    ...
    public bool CanModifyTerrain { get; set; }
