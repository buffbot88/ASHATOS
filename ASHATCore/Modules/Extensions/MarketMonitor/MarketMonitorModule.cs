...
namespace ASHATCore.Modules.Extensions.MarketMonitor;
...
public sealed class MarketMonitorModule : ModuleBase
{
    ...
    public void RecordExchange(CurrencyExchangeTransaction Transaction)
    {
        ...
        {
            CreateAlert(
                MarketAlertType.ASHATpidPriceChange,
    ...
    /// <summary>
    /// Validate exchange Rate against standard ASHATtio.
    ...
    private string AnalyzeMarket()
    {
        ...
        sb.AppendLine("  ✓ Standard ASHATtio enforced across all exchanges");
    ...
    private string ResolveAlert(Guid alertId)
    {
        if (_alerts.TryGetValue(alertId, out var alert))
        {
            ...
            alert.Resolution = "Manually resolved by administASHATtor";
